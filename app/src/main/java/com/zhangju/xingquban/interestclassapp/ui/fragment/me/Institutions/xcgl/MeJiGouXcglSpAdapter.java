...
public class MeJiGouXcglSpAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public MeJiGouXcglSpAdapter(Context context, MeJiGouSpkcSpjBean meJiGouSpkcSpjBean) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        holder1.meJjglXcglTrue.setVisibility(View.GONE);
...
//            this.list.add(bean);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.me_jjgl_xcgl_true)
        ImageView meJjglXcglTrue;
