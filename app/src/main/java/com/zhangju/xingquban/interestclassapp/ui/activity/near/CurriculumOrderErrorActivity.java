 ...
 */
@ContentView(R.layout.curriculum_ordererror_pay)
public class CurriculumOrderErrorActivity extends FastActivity implements View.OnClickListener {
    ...
    private void bindDataToView() {
        ...
        tvOrderSucess.setText("支付失败");
        tvJxgoumai.setVisibility(View.GONE);
        tvGodingdan.setVisibility(View.GONE);
