...
//问答草稿详情
public class FindWDCgWdXq extends BaseActivity {
    public static final String TAG = "FindWDCgWdXq";
    ...
    Observer<FindMeWendaXqBean> observer1 = new Observer<FindMeWendaXqBean>() {
        ...
        public void onNext(FindMeWendaXqBean findMeWendaXqBean) {
            ...
            isCollect = findMeWendaXqBean.getAaData().get(0).isIsCollection();
            Glide.with(FindWDCgWdXq.this).load(isCollect == true ? R.mipmap.find_wdxqstart_true : R.mipmap.find_wdxqstart_false).into(image_find_collect);
    ...
    Observer<FindTiWenXqPlBean> observer2 = new Observer<FindTiWenXqPlBean>() {
        ...
        public void onNext(FindTiWenXqPlBean findTiWenXqPlBean) {
            ...
            ScrollLinearLayoutManager linearLayoutManager = new ScrollLinearLayoutManager(mContext);
    ...
    public int getLayout() {
        return R.layout.activity_find_wdcg_wd_xq;
    }
    ...
    public void setFindWdSc() {
        ...
        subscription = NetWork.getMeTiwen().myQuestionWd(1, false, id1)
...
//                ToastUtil.showToast("收藏成功");
    ...
    //收藏调用
    private void setFindWdScs() {
        subscription = NetWork.getMeTiwen().questionCollection(UserManager.getInstance().getUser().id, id1)
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(observer3);
    }
