...
public class FindItemPLRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private FindTiWenXqPlBean.AaDataBean find;
    private Context mContext;

    public FindItemPLRecyclerAdapter(Context context, FindTiWenXqPlBean.AaDataBean findWDBean) {
