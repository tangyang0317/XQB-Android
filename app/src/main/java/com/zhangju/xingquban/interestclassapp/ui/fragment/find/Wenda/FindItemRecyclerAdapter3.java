...
public class FindItemRecyclerAdapter3 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private FindMeCgTwXqBean.AaDataBean find;
    private Context mContext;

    public FindItemRecyclerAdapter3(Context context, FindMeCgTwXqBean.AaDataBean findWDBean) {
