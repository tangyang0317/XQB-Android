...
public class GridViewPager
    ...
    public void setGridViewPagerDataAdapter(GridViewPagerDataAdapter gridViewPagerDataAdapter) {
        ...
        if (gridViewPagerDataAdapter.listAll == null || gridViewPagerDataAdapter.listAll.size()
                == 0) {
            return;
        }
    ...
    public void init() {
        ...
        gridViewPagerDataAdapter.getPageSum(pageCount);
        ...
        for (int i = 0; i < pageCount; i++) {
            ...
            gv.setAdapter(gridViewPagerDataAdapter.getGridViewAdapter(listAll.subList(i *
                    sizeInOnePage, end), i));
            gv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                @Override
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    gridViewPagerDataAdapter.onItemClick(parent, view, position, id, pageIndex);
                }
            });
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        heightMeasureSpec = MeasureSpec.makeMeasureSpec(height + getPaddingBottom() +
