...
public class MeJiGouKcglKctjCityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    private MeJiGouKcglKctjCityBean mMeJiGouKcglKctjCityBean;
    ...
    public void addData(MeJiGouKcglKctjCityBean meJiGouKcglKctjCityBean) {
        mMeJiGouKcglKctjCityBean.getAaData().addAll(meJiGouKcglKctjCityBean.getAaData());
        notifyDataSetChanged();
    }

    public MeJiGouKcglKctjCityBean getData() {
        return this.mMeJiGouKcglKctjCityBean;
    }

    public MeJiGouKcglKctjCityAdapter(Context context, MeJiGouKcglKctjCityBean meJiGouKcglKctjCityBean) {
