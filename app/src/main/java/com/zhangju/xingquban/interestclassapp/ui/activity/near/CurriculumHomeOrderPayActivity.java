...
public class CurriculumHomeOrderPayActivity extends FastActivity implements View.OnClickListener {
                ...
                public void onResponseListener(Request r, String result) {
                    ...
                    if (payByWechatCheck.isChecked()) {
                        ...
                        try {
                            ...
                            ThirdPartyUtils.getInstance(CurriculumHomeOrderPayActivity.this).payByWechat(appid, partnerId, prepayId, timestamp, packageValue, nonceStr, sign);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        ...
                        try {
                            sign = jso.getString("sign");
                            ThirdPartyUtils.getInstance(CurriculumHomeOrderPayActivity.this).payByAli(CurriculumHomeOrderPayActivity.this, sign);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }
                        ...
                        try {
                            ...
                            if (ispay) {
                                Intent intent2 = new Intent(CurriculumHomeOrderPayActivity.this, CurriculumOrderSucessActivity.class);
                                Bundle bundle = new Bundle();
                                bundle.putSerializable(CurriculumOrderSucessActivity.ARG_STRING_ORDERNUM, orderson);
                                bundle.putString(CurriculumOrderSucessActivity.ARG_STRING_PIC, lessonsBea.getPicture());
                                bundle.putString(CurriculumOrderSucessActivity.ARG_STRING_NAME, lessonsBea.getName());
