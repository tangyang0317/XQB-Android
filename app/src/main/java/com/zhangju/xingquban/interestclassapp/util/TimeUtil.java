...
public class TimeUtil {
    ...
    public static String getTimeDifferenceHour(String starTime, String endTime) {
        ...
        try {
            ...
            int hour1 = (int) (parseFloat / (60 * 60 * 1000));

            timeString = Integer.toString(hour1);
        } catch (ParseException e) {
            e.printStackTrace();
        }
        return timeString + "小时前";
    ...
    /***
     * 获取当前详细时间2017-10-10 -10-10-10
     * @param dateTime   待处理的日期
     * @param n 加减天数
     * @return
     */

    public static String getTimeDetail(int n) {
