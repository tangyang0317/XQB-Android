...
public class MeJiGouKcglKctjCity extends BaseActivity {
    public static final String TAG = "MeJiGouKcglKctjCity";
                ...
                if (lood) {
                    ...
                    mejgkcglAdapter.setOnItemClickListener(new MeJiGouKcglKctjCityAdapter.OnItemClickListener() {
                        ...
                        public void onItemClick(View view, int position) {
                            String pid = meJiGouKcglKctjCityBean.getAaData().get(position).getId();
                            Intent intent = new Intent(mContext, MeJiGouKcglKctjCity2.class);
    ...
    public int getLayout() {
        return R.layout.activity_me_ji_gou_kcgl_kctj_city;
    }
    ...
    public void getCity() {
        subscription = NetWork.getMe().city(PageNumber, PageSize + "")
