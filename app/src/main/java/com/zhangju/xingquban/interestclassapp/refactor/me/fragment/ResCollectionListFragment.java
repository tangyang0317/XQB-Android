...
import com.zhangju.xingquban.interestclassapp.refactor.me.adapter.ResCollectionAdapter;
import com.zhangju.xingquban.interestclassapp.refactor.me.adapter.ResCollectionAdapter2;
...
public class ResCollectionListFragment extends FastFragment{
    @Bind(com.fastlib.R.id.refresh)
    SwipeRefreshLayout mRefresh;
    @Bind(com.fastlib.R.id.list)
    RecyclerView mList;
    ResCollectionAdapter2 mAdapter;

    @Override
    protected void alreadyPrepared(){
        mList.setAdapter(mAdapter=new ResCollectionAdapter2(getContext()));
