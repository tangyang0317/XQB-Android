...
public class DraftQuestionFragment extends FastFragment implements SwipeRefreshLayout.OnRefreshListener, SwipeRefreshAdapterView.OnListLoadListener {
    ...
    private void setAskQuestionAdapter() {
        ...
        questionMainAdapter = new QuestionPopAdapter(getActivity(), questionList, 1);
        ...
        questionMainAdapter.setOnClickListenner(new QuestionPopAdapter.OnClickListenner() {
            ...
            public void setonListenner(int pos) {
                ...
                Intent intent = new Intent(getActivity(), MyAddQuestionActivity.class);
